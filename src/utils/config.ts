...
export const WS_URL = "ws://localhost:28600";
...
export const API_ENDPOINTS = {
  ...
  specialOps: {
    ...
    countByRoomsGreaterThan: (minRooms: number) =>
      `/flats/count/rooms-greater-than/${minRooms}`,
    ...
    findByLivingSpaceLessThan: (maxSpace: number) =>
      `/flats/search/by-living-space-less-than/${maxSpace}`,
